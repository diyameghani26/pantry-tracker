...
//       category: category.toLowerCase(), // ✅ lowercase for consistency
//       expiryDate,
//     };
...
//       <div className="bg-white shadow-lg rounded-xl p-5 sm:p-8 w-full max-w-md relative">
...
const AddItems = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const newItem = {
      id: Date.now(),
      name: itemName.trim(),
      quantity: parseFloat(quantity), // ✅ allow decimals
      unit, // ✅ store selected unit
